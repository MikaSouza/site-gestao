						...
						<div class="company-faq left-faq">
							<?php foreach (getOrientacoesTecnicas() as $orientacao) : ?>
								...
								<div class="single-faq">
									<h4><span class="number">></span> <span class="q-text"><a href="<?php echo $remote_filename; ?>" target="_blanc" class="down-btn"><?php echo $orientacao['OXTTITULO']; ?></a></span>
									</h4>
									<?php if (count($orientacao['ANEXOS']) > 0) : ?>
										<?php foreach ($orientacao['ANEXOS'] as $anexo) : ?>
											<div class=" download-btn">
												<div class="about-btn">
													<a href="<?php echo $anexo['LINK']; ?>" target="_blanc" class="down-btn"><?php echo $anexo['NOMEARQUIVO']; ?><i class="fa fa-file-pdf-o"></i></a>
												</div>
											</div>
										<?php endforeach; ?>
									<?php endif; ?>
