                    ...
                    <div class="row">
                        <form class="contact-form" id="formFormulario" name="formFormulario" method="POST" action="enviarFormulario">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <input type="text" class="form-control" id="vSFORDESCREGINTERNO" name="vSFORDESCREGINTERNO" value="<?= ($vIOid > 0 ? $vROBJETO['FORDESCREGINTERNO'] : ''); ?>" placeholder="Se sim, descrever o número, ato legal, e anexar uma cópia:">
                                <div class="help-block with-errors"></div>
                            </div>
                            <!-- Dados Gerais -->
