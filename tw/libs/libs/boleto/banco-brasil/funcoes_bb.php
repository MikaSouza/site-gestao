...
$retorno .= '<img src="/admin/libs/boleto/banco-brasil/imagens/p.gif" width='.$fino.' height='.$altura.' border=0>
				<img src="/admin/libs/boleto/banco-brasil/imagens/b.gif" width='.$fino.' height='.$altura.' border=0>
				<img src="/admin/libs/boleto/banco-brasil/imagens/p.gif" width='.$fino.' height='.$altura.' border=0>
				<img src="/admin/libs/boleto/banco-brasil/imagens/b.gif" width='.$fino.' height='.$altura.' border=0>';
...
while (strlen($texto) > 0) {
  ...
  for($i=1;$i<11;$i+=2){
    ...
    $retorno .= '<img src=/admin/libs/boleto/banco-brasil/imagens/p.gif width='.$f1.' height='.$altura.' border=0>';
    ...
    $retorno .= '<img src=/admin/libs/boleto/banco-brasil/imagens/b.gif width='.$f2.' height='.$altura.' border=0>'; 
	
  }
}

// Draw guarda final
$retorno .= '<img src=/admin/libs/boleto/banco-brasil/imagens/p.gif width='.$largo.' height='.$altura.' border=0> 
				<img src=/admin/libs/boleto/banco-brasil/imagens/b.gif width='.$fino.' height='.$altura.' border=0> 
				<img src=/admin/libs/boleto/banco-brasil/imagens/p.gif width=1 height='.$altura.' border=0>';
