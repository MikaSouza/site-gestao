			...
			<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						...
						<input title="URL Amigável" type="text" id="vSBLOURLAMIG" name="vSBLOURLAMIG" class="form-control" placeholder="URL Amigável" value="<?php echo escape_aspas_inputs($fill['BLOURLAMIG'], "input"); ?>" maxlength="100" required>
					</div>
				</div>
			</div>
			<div class="row">
